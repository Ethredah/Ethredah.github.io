...
<div class="footer">
		<div class="col-md-4 footer-left-agileits">
			<h3>Address</h3>
				<ul>
					<li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Relaince center , Woodvale Grove, Westlands - Nairobi, Kenya</li>
					<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="mailto:info@ushaurionline.net">info@ushaurionline.net</a></li>
...
<!-- //footer --> 
	<div class="copyright-w3-agile">
		<div class="container">
			<p>© 2018 Ushauri | All rights reserved.</p>
			<div class="clearfix"> </div>
		</div>
	</div>
